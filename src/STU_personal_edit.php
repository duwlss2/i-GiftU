    ...
    <main>
        <div class="row center-align" style="margin-top:48px">
            <div class="left-align col s12 m8 l5" style="display:inline-block;float: none;padding:0">
              ...
              <form action="STU_personal_process.php?id=<?php echo $_GET['id']; ?>" method="post">
                   <!--내용물 한블럭-->
                   <div class="card center-align" style="margin:0; border-radius:0; padding:15px">
                      <b style="font-size:16px">사연 글쓰기</b>


                      <div class="left-align" style="font-size:15px; padding:0 5%; line-height:30px; margin-top:15px; ">
                   ...
                   <div class="row">
                     <button  style="background-color: #005e39; " id='save' type = "submit" class="btn btn-primary">Save Profile</button>
                   </div>
