    ...
    <div class="row" style="margin-bottom : 0;">
      <div class="col s12 m12 l6 center-align" style="display: inline-block; float: none">
        ...
        <div class="card-panel hoverable black-text navbar-fixed-bottom" style="padding-top: 15px; z-index:0; background-color:#cfead6">
            ...
            <button class="btn waves-effect waves-light hoverable col s12 m12 l12" type="submit" name="action" data-target="checkAgain" style="display: inline-block; float: none; height:47px; font-size: 25px;background-color:#003c1f">쿠폰 보내러가기
            </button>
        </div>
        ...
        <!-- 주문재확인팝업 -->
          <div id="checkAgain" class="modal">
            ...
            <div class="modal-footer">
              ...
              <a href="doneOrderpurchase.php" class="modal-action modal-close waves-effect waves-green btn-flat" style="width:50%; font-size:17px">네</a>
            </div>
          </div>
      </div>
    </div>
