  ...
  <body>
            ...
            <div class="col s9 m9 l6 center-align" style="display: inline-block; float: none">
                <div style="padding:2px; padding-top:6px" class="card">
                                  ...
                                  if(empty($_GET['id'])===false){
                                    $sql = 'SELECT * FROM moms_food WHERE menu='.$_GET['id'];
                                    $result = mysqli_query($conn, $sql);
                                    $row = mysqli_fetch_assoc($result);
                                    $_SESSION['restaurant'] = "moms_food"; ?>
    ...
    <footer class="navbar-fixed-bottom">
       <table  style="width:100%; height:50px">
           <tr>
               <td style="padding:0">
                   <a href="preorder.php?id=<?php echo $_GET['id']; ?>"><button class="waves-effect waves-light btn" style="width:100%; height:55px; background-color:#5d4037; padding= 0px; font-size:17px; border-radius:0">미리주문</button></a>
               </td>

               <td style="padding:0">
                   <a href="purchase.php?id=<?php echo $_GET['id']; ?>"><button class="waves-effect waves-light btn" style="width:100%; height:55px; background-color: #ff5252 ; padding= 0px; font-size:17px; border-radius:0">선물하기</button></a>
               </td>
           </tr>
       </table>
    </footer>
