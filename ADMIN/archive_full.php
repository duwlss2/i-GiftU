...
.content1 { width: 720px; }
  ...
  <body>
    ...
    <div class="col s12">
      <ul class="tabs">
        <li class="tab col s3"><a href="#test1">인물소개</a></li>
        <li class="tab col s3"><a href="#test2">섬기는</a></li>
        <li class="tab col s3"><a href="#test3">한알의밀알</a></li>
        <li class="tab col s3"><a href="#test4">우리팀</a></li>
        <li class="tab col s3"><a href="#test5">DREAM</a></li>
        <li class="tab col s3"><a href="#test6">갈대상자</a></li>
      </ul>
    </div>

    <div id="test1" class="col s12 l6">
      <img src="./img/archive/1-0.png" alt="" width="100%"  border="0">
      <!-- <iframe width="100%" height="100%" src="https://www.youtube.com/embed/JclrNqY83wU" frameborder="0" allowfullscreen=""></iframe> -->
...
<iframe width="100%" height="40%" src="https://www.youtube.com/embed/PeGURj03kIw" frameborder="0" allowfullscreen></iframe>
...
<div class="textboxL">제 꿈은 한국 기업들의 업무 환경을 개선하는 것입니다. 회사를 소개할 때 ‘야근이 없다는 것’을 엄청난 복지 혜택이라고 칭송하며 마치 자랑인 것 마냥 내세우는 뉴스 기사들을 보면 아직까지도 야근이 당연시되는 사회인 것 같아 안타까운 마음뿐입니다. 여성들의 경우 특히 결혼과 육아 때문에 자신의 전문성과 커리어를 포기하는 일이 비일비재하게 일어나고 있습니다. 이 분야에서 전문성을 길러 차기 한국 기업들을 이끌어갈 리더들을 교육시키고 이끌어줄 수 있는 사람이 되고 싶습니다.

</div>

<div class="textboxR">저는 공연영상학과 시각디자인을 전공으로 공부하고 있는 강인애입니다. 저의 꿈은 학교에서 배우고 습득한 스토리텔링 기법으로 하나님 나라의 이야기를 풀어내는 것입니다. 지금은 그 기술이 부족한 것은 물론이고, 하나님 나라에 대한 이해도 제멋대로지만 꿈을 위해 즐겁게 배워나가고 있습니다. 최종적으로는 같은 꿈을 꾸는 동료들과 함께 일할 수 있는 공간을 만들고 싶습니다.</div>

<div class="textboxL">군대에 입대를 하기 전에는 뚜렷한 꿈이 없었습니다. 2년이라는 시간이 흘러 많은 고민 끝에 서비스와 관련된 있는 일을 하고 싶다는 꿈을 갖게 되었고 지금은 항공사에서 일하는 승무원을 꿈꾸게 되었습니다. 겸손한 마음으로 고객들을 응대하고 맞추면서 서비스를 제공해드리고 싶음 마음과 함께 ‘그 누구보다도 고객을 이해하고 도와줄 수 있는 Service Giver’가 되는 것이 저의 꿈입니다.

</div>

<div class="textboxR">계절이 바뀔 때마다, 밤과 낮의 하늘을 올려다 볼 때마다 참 멋진 디자이너의 아름다운 디자인이라는 생각을 하곤합니다. 세상을 선하고 아름답게 창조하신 디자이너 하나님을 닮는 것이 저의 꿈 입니다. 태초부터 우리를 위해 필요한 것들을 아름답게 만드신 사랑을 담아 꼭 필요한 곳에 선하게 쓰여지는 디자인을 할 수 있길 소망합니다.<br /><br />
  <br /><br />
  ...
  <br /><br />
    ...
    <div id="test6" class="col s12">
      <div class="content1"><img src="images/sub06_title.jpg" alt="" width="720" border="0">
...
<center><img src="images/sub06_01.jpg" alt="" width="664"  border="0" class="exp"></center><br />
...
<center><img src="images/sub06_02.jpg" alt="" width="664"  border="0" class="exp"></center><br />
...
<p><b class="st7">학생들의 답장</b><br/>


<center><img src="images/sub06_03.jpg" alt="" width="664"  border="0" class="exp"></center><br />


<center><img src="images/sub06_04.jpg" alt="" width="664"  border="0" class="exp"></center><br />

<center><img src="images/sub06_05.jpg" alt="" width="664"  border="0" class="exp"></center><br />

<center><img src="images/sub06_06.jpg" alt="" width="664"  border="0" class="exp"></center><br />

<center><img src="images/sub06_07.jpg" alt="" width="664"  border="0" class="exp"></center><br />

<center><img src="images/sub06_08.jpg" alt="" width="664"  border="0" class="exp"></center><br />

<center><img src="images/sub06_09.jpg" alt="" width="664"  border="0" class="exp"></center><br />

<center><img src="images/sub06_10.jpg" alt="" width="664"  border="0" class="exp"></center><br />

<center><img src="images/sub06_11.jpg" alt="" width="664"  border="0" class="exp"></center><br />

<center><img src="images/sub06_12.jpg" alt="" width="664"  border="0" class="exp"></center><br />

<center><img src="images/sub06_13.jpg" alt="" width="664"  border="0" class="exp"></center><br />

<center><img src="images/sub06_14.jpg" alt="" width="664"  border="0" class="exp"></center><br />

<center><img src="images/sub06_15.jpg" alt="" width="664"  border="0" class="exp"></center><br />




<p>
 <a href="http://sarang.handong.edu/sarang " target="_blank">▶한동을 따뜻하게 만드는 '갈대상자함께엮기' 참여하기</a><br />
  ...
  <div class="fixed-action-btn" >
     <a class="btn-floating btn-large" style="background-color : #d31e89">
