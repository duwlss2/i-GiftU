...
ob_start();
  ...
  //   echo '<iframe src="preorder_sound.php" width="0" height="0"></iframe>';
  // } else{
  ...
  // }
      // echo '<iframe src="preorder_sound.php" width="0" height="0"></iframe>'; //쿠키비교해서 작으면 소리 띄운다.
      // echo '<object data="preorder_sound.php" type="text/html" title="제목">
      //       </object>';
...
<html lang="ko">
  <head>
    ...
    <!-- <script type="text/javascript">
        var sound = new buzz.sound("sound.mp3");
        $('body').load('0209preOrder.php body', function(){
            sound.play();
    ...
    <video src="sound.mp3" onclick="this.play();"></video>
  </head>
  <script>
  ...
  <script language='javascript'>
    window.setTimeout('window.location.reload()',1000*10); //18초마다 리플리쉬 시킨다 1000이 1초가 된다.
  </script>
...
<body onload="startTime()">
    ...
    <main class="center-align">
        ...
        <div class="row">
        <div class="col s12 m8 l3" style="display: inline-block; float: none; padding:5px; padding-top:0; background-color:#c7c7c7">
        ...
        ?>
            ...
            <div class="card-panel" style="padding: 15px; margin:0; margin-top:5px">
              <table>
                  ...
                  <tr>
                      <td style="font-size:25px; margin-top : 5px"><b><?php echo $row['menu'];?><?php echo $row['choice'];?>
